...
import QueryResults = require("./util/QueryResults");
...
var __HeaderOptions = {
	...
	__PutDirectives = dojoDeclare(Store.PutDirectives, __HeaderOptions),
	__QueryOptions = dojoDeclare(Store.QueryOptions, __HeaderOptions);
=====*/

export = dojoDeclare("dojo.store.JsonRest", base, {
    // summary:
