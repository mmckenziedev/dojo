...
import nlsNumber = require("./i18n!./cldr/nls/number");
import dstring = require("./string");
import dregexp = require("./regexp");
...
/*=====
number.__FormatOptions = dojoDeclare(null, {
	// pattern: String?
...
/*=====
number.__FormatAbsoluteOptions = dojoDeclare(null, {
	// decimal: String?
...
/*=====
number.__RegexpOptions = dojoDeclare(null, {
	// pattern: String?
	//		override [formatting pattern](http://www.unicode.org/reports/tr35/#Number_Format_Patterns)
	//		with this string.  Default value is based on locale.  Overriding this property will defeat
	//		localization.
...
/*=====
number.__ParseOptions = dojoDeclare(null, {
	// pattern: String?
	//		override [formatting pattern](http://www.unicode.org/reports/tr35/#Number_Format_Patterns)
	//		with this string.  Default value is based on locale.  Overriding this property will defeat
	//		localization.  Literal characters in patterns are not supported.
...
/*=====
number.__RealNumberRegexpFlags = dojoDeclare(null, {
	// places: Number?
...
number._realNumberRegexp = function( /*__RealNumberRegexpFlags?*/ flags) {
    ...
    var exponentRE = dregexp.buildGroupRE(flags.exponent,
        function(q) {
            if (q) {
                return "([eE]" + number._integerRegexp({
                    signed: flags.eSigned
                }) + ")";
            }
            return "";
        }
...
/*=====
number.__IntegerRegexpFlags = dojoDeclare(null, {
	// signed: Boolean?
