...
import dnumber = require("./number");
import i18n = require("./i18n");
import nlsCurrency = require("./i18n!./cldr/nls/currency");
import cldrMonetary = require("./cldr/monetary");
...
/*=====
currency.__FormatOptions = dojoDeclare([dnumber.__FormatOptions], {
	// type: String?
...
/*=====
var __ParseOptions = currency.__ParseOptions = dojoDeclare(dnumber.__ParseOptions, {
	// type: String?
	//		Should not be set.  Value is assumed to be currency.
	// currency: String?
	//		an [ISO4217](http://en.wikipedia.org/wiki/ISO_4217) currency code, a three letter sequence like "USD".
