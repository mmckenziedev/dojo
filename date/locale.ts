...
import supplemental = require("../cldr/supplemental");
import i18n = require("../i18n");
import regexp = require("../regexp");
import string = require("../string");
import gregorian = require("../i18n!../cldr/nls/gregorian");
...
/*=====
var __FormatOptions = exports.__FormatOptions = dojoDeclare(null, {
	// selector: String
...
export const _getZone = function( /*Date*/ dateObject, /*boolean*/ getName, /*__FormatOptions?*/ options) {
    // summary:
...
export const format = function( /*Date*/ dateObject, /*__FormatOptions?*/ options) {
    // summary:
...
export const regexp = function( /*__FormatOptions?*/ options) {
    // summary:
...
export const _parseInfo = function( /*__FormatOptions?*/ options) {
    options = options || {};
    var locale = i18n.normalizeLocale(options.locale),
        bundle = exports._getGregorianBundle(locale),
        formatLength = options.formatLength || 'short',
...
export const parse = function( /*String*/ value, /*__FormatOptions?*/ options) {
    // summary:
...
export const addCustomFormats = function( /*String*/ packageName, /*String*/ bundleName) {
    // summary:
...
export const _getGregorianBundle = function( /*String*/ locale) {
...
export const addCustomFormats(module.id.replace(/\/date\/locale$/, ".cldr"), "gregorian");

export const getNames = function( /*String*/ item, /*String*/ type, /*String?*/ context, /*String?*/ locale) {
    // summary:
...
export const isWeekend = function( /*Date?*/ dateObject, /*String?*/ locale) {
    // summary:
...
export const _getDayOfYear = function( /*Date*/ dateObject) {
    // summary:
    //		gets the day of the year as represented by dateObject
    return date.difference(new Date(dateObject.getFullYear(), 0, 1, dateObject.getHours()), dateObject) + 1; // Number
};

export const _getWeekOfYear = function( /*Date*/ dateObject, /*Number*/ firstDayOfWeek) {
