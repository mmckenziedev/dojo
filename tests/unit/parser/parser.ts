define([
	...
	function setup(id, shouldReturn) {
		return function () {
			...
			dojoDeclare('tests.parser.Widget', null, {
				constructor: function (args) {
					this.params = args;
				}
			});

			dojoDeclare('tests.parser.Class1', null, {
				constructor: function (args) {
					this.params = args;
			...
			dojoDeclare('tests.parser.Class2', null, {
			...
			dojoDeclare('tests.parser.Class3', tests.parser.Class2, {
				fromMarkup: false,
			...
			dojoDeclare('tests.parser.InputClass', null, {
				constructor: function (args) {
					this.params = args;
					lang.mixin(this, args);
				},
			...
			dojoDeclare('tests.parser.BidiClass', tests.parser.Widget, {
			...
			// stopParser flag
			dojoDeclare('tests.parser.NormalContainer', null, {
				constructor: function (args) { lang.mixin(this, args); }
			});
			dojoDeclare('tests.parser.ShieldedContainer', null, {
				constructor: function (args) { lang.mixin(this, args); },
			...
			dojoDeclare('tests.parser.HTML5Props', null, {
				constructor: function (args) { lang.mixin(this, args); },
				simple: false,
				a: 2,
				b: null,
			...
			dojoDeclare('tests.parser.HTML5withMethod', null, {
				constructor: function (args) { lang.mixin(this, args); },
				baseValue: 10,
				someMethod: function () {
			...
			dojoDeclare('tests.parser.StatefulClass', [Evented, Stateful], {
				strProp1: '',
				objProp1: {},
				boolProp1: false,
			...
			dojoDeclare('tests.parser.MethodClass', null, {
				method1ran: false,
				method1after: false,
				method2ran: false,
				method2before: false,
			...
			dojoDeclare('tests.parser.ClassForMixins', null, {
				classDone: true
			});

			dojoDeclare('tests.parser.Mixin1', null, {
				mixin1Done: true
			});

			dojoDeclare('tests.parser.Mixin2', null, {
				mixin2Done: true
			});

			dojoDeclare('tests.resources.AMDWidget', null, {
				constructor: function (args) {
					this.params = args;
				}
			});

			dojoDeclare('tests.resources.AMDWidget2', null, {
				constructor: function (args) {
					this.params = args;
				},
			...
			dojoDeclare('tests.resources.AMDWidget3', null, {
				constructor: function (args) {
					this.params = args;
				}
			});
			...
			tests.parser.FormClass = dojoDeclare(tests.parser.Widget, {
				encType: ''
			});
	...
	registerSuite({
		...
		'no start': function () {
			var started = false;
			dojoDeclare('SampleThinger', null, {
				startup: function () {
					started = true;
				}
			});
	...
	registerSuite({
		...
		'onclick': function () {
			dojoDeclare('tests.parser.Button', null, {
				onClick: function () {
