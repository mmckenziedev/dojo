	...
	define([
		...
		registerSuite({
			...
			'smoke test 1': function () {
				dojoDeclare('tests._base.declare.tmp', null);
				dojoDeclare('testsFoo', null);
			...
			'smoke test 2': function () {
				...
				dojoDeclare('tests._base.declare.foo', null, {
					foo: 'thonk'
				});
			...
			'smoke test with Ctor': function () {
				...
				dojoDeclare('tests._base.declare.fooBar', null, {
			...
			'smoke test compact args': function () {
				...
				dojoDeclare('tests._base.declare.fooBar2', null, {
					foo: 'thonk'
				});
			...
			'subclass': function () {
				...
				dojoDeclare('tests._base.declare.tmp3', null, {
					foo: 'thonk'
				});

				dojoDeclare('tests._base.declare.tmp4', global.tests._base.declare.tmp3);
			...
			'subclass with Ctor': function () {
				...
				dojoDeclare('tests._base.declare.tmp5', null, {
					constructor: function () {
						this.foo = 'blah';
					},
					foo: 'thonk'
				...
				dojoDeclare('tests._base.declare.tmp6', global.tests._base.declare.tmp5);
			...
			'mixin subclass': function () {
				...
				dojoDeclare('tests._base.declare.tmp7', null, {
					foo: 'thonk'
				});

				dojoDeclare('tests._base.declare.tmp8', null, {
					constructor: function () {
						this.foo = 'blah';
					}
				});
				...
				dojoDeclare('tests._base.declare.tmp9', [
			...
			'super class ref': function () {
				...
				dojoDeclare('tests._base.declare.tmp10', null, {
					foo: 'thonk'
				});

				dojoDeclare('tests._base.declare.tmp11', global.tests._base.declare.tmp10, {
					constructor: function () {
						this.foo = 'blah';
					}
				});
			...
			'inherited call': function () {
				...
				dojoDeclare('tests._base.declare.tmp12', null, {
					foo: 'thonk',
				...
				dojoDeclare('tests._base.declare.tmp13', global.tests._base.declare.tmp12, {
					constructor: function () {
						this.foo = 'blah';
					}
				});
			...
			'inherited explicit call': function () {
				...
				dojoDeclare('tests._base.declare.tmp14', null, {
					foo: 'thonk',
					bar: function (arg1, arg2) {
						if (arg1) {
							this.foo = arg1;
				...
				dojoDeclare('tests._base.declare.tmp15', global.tests._base.declare.tmp14, {
					constructor: function () {
						this.foo = 'blah';
					},
					bar: function (arg1, arg2) {
			...
			'inherited with mixin calls': function () {
				...
				dojoDeclare('tests._base.declare.tmp16', null, {
					foo: '',
					bar: function () {
						this.foo += 'tmp16';
					}
				...
				dojoDeclare('tests._base.declare.mixin16', null, {
					bar: function () {
				...
				dojoDeclare('tests._base.declare.mixin17', global.tests._base.declare.mixin16, {
					bar: function () {
						this.inherited(arguments);
						this.foo += '.mixin17';
					}
				...
				dojoDeclare('tests._base.declare.tmp17', [
			...
			'basic mixin': function () {
				...
				dojoDeclare('tests.Thinger', Thing, {
					method: function () {
						this.inherited(arguments);
					}
				});
			...
			'mutated methods': function () {
				...
				dojoDeclare('tests._base.declare.tmp18', null, {
				...
				dojoDeclare('tests._base.declare.tmp19', global.tests._base.declare.tmp18, {
			...
			'modified instance': function () {
				...
				dojoDeclare('tests._base.declare.tmp20', null, {
					foo: function () { stack.push(20); }
				});

				dojoDeclare('tests._base.declare.tmp21', null, {
					foo: function () {
						this.inherited(arguments);
						stack.push(21);
					}
				...
				dojoDeclare('tests._base.declare.tmp22', global.tests._base.declare.tmp20, {
					foo: function () {
						this.inherited(arguments);
						stack.push(22);
					}
				...
				dojoDeclare('tests._base.declare.tmp23', [
			...
			'duplicated base': function () {
				var stack;
				var tmp;
				var A = dojoDeclare(null, {
					constructor: function () {
						stack.push(1);
					}
				});
				var B = dojoDeclare([A, A, A], {
					constructor: function () {
						stack.push(2);
					}
				});
			...
			'indirectly duplicated base': function () {
				...
				var C = dojoDeclare([A, B], {
					constructor: function () {
						stack.push(3);
					}
				});
				var D = dojoDeclare([B, A], {
					constructor: function () {
						stack.push(4);
					}
				});
			...
			'no new': function () {
				...
				// created by dojoDeclare(), so I need to test all
				// three.
				...
				noNewTest(dojoDeclare(A));

				// Make sure multiple inheritance call works
				var B = dojoDeclare(A);
				var C = dojoDeclare(null, { ctest: function () { return true; } });
				var D = dojoDeclare([A, B, C], { dtest: function () { return true; } });
				noNewTest(D);
