...
//begin v1.x content
{
	...
	"field-year": "Year",
	"days-format-narrow@localeAlias39": {
		"bundle": "gregorian",
	...
	"days-standAlone-short@localeAlias44": {
		"bundle": "gregorian",
		"target": "days-format-short"
	},
	"days-standAlone-short@localeAlias45": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"months-standAlone-wide@localeAlias36": {
		"bundle": "chinese",
		"target": "months-format-wide"
	},
	"days-standAlone-short@localeAlias46": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"quarters-standAlone-wide@localeAlias53": {
		"bundle": "gregorian",
	...
	"quarters@localeAlias48": {
		"bundle": "gregorian",
		"target": "quarters"
	},
	"dateTimeFormats-appendItem-Second": "{0} ({2}: {1})",
	"quarters-format-abbr@localeAlias49": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	...
	"days-format-abbr@localeAlias38": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"days-standAlone-wide@localeAlias47": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"days-format-short@localeAlias40": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-format-short@localeAlias41": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"dayPeriods-format-abbr@localeAlias55": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-wide"
	},
	"dayPeriods-format-abbr@localeAlias56": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-wide"
	},
	...
	"months-format-narrow@localeAlias33": {
		"bundle": "chinese",
	...
	"dateFormatItem-y": "U",
	"months-format-abbr@localeAlias32": {
		"bundle": "chinese",
		"target": "months-format-wide"
	},
	...
	"quarters-format-narrow@localeAlias50": {
		"bundle": "gregorian",
	...
	"months-standAlone-abbr@localeAlias34": {
		"bundle": "chinese",
		"target": "months-format-abbr"
	},
	"quarters-standAlone-abbr@localeAlias51": {
		"bundle": "gregorian",
		"target": "quarters-format-abbr"
	},
	"months-standAlone-abbr@localeAlias35": {
		"bundle": "chinese",
		"target": "months-format-wide"
	},
	"quarters-standAlone-abbr@localeAlias52": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"dayPeriods-format-wide-noon": "noon",
	"days-standAlone-abbr@localeAlias42": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-standAlone-abbr@localeAlias43": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"days-format-wide": [
