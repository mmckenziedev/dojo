...
//begin v1.x content
{
	...
	"days-format-abbr@localeAlias442": {
		"bundle": "gregorian",
	...
	"months-format-narrow@localeAlias437": {
		"bundle": "islamic",
	...
	"dateFormat@localeAlias466": {
		"bundle": "islamic",
		"target": "dateFormat"
	},
	"dateFormatItem-yyyyMd": "GGGGG y-MM-dd",
	"field-day": "Day",
	"dateFormat@localeAlias467": {
		"bundle": "generic",
		"target": "dateFormat"
	},
	"field-year-relative+-1": "last year",
	"quarters-standAlone-wide@localeAlias458": {
		"bundle": "gregorian",
	...
	"quarters-standAlone-abbr@localeAlias456": {
		"bundle": "gregorian",
		"target": "quarters-format-abbr"
	},
	"quarters-standAlone-abbr@localeAlias457": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	...
	"months-standAlone-wide@localeAlias439": {
		"bundle": "islamic",
		"target": "months-format-wide"
	},
	"days-standAlone-short@localeAlias448": {
		"bundle": "gregorian",
	...
	"quarters-format-abbr@localeAlias454": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"days-standAlone-short@localeAlias449": {
		"bundle": "gregorian",
	...
	"months-standAlone-abbr@localeAlias438": {
		"bundle": "islamic",
	...
	"field-hour": "Hour",
	"days-format-short@localeAlias444": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"months-format-wide": [
	...
	"days-format-short@localeAlias445": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"days-standAlone-short@localeAlias450": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"dateFormat-full": "G y MMMM d, EEEE",
	"field-month-relative+-1": "last month",
	"dayPeriods-format-abbr@localeAlias461": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-wide"
	},
	"dateFormatItem-Hms": "HH:mm:ss",
	"dayPeriods-format-abbr@localeAlias462": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-wide"
	},
	...
	"timeFormat@localeAlias468": {
		"bundle": "islamic",
		"target": "timeFormat"
	},
	"timeFormat@localeAlias469": {
		"bundle": "gregorian",
		"target": "timeFormat"
	},
	...
	"days-format-narrow@localeAlias443": {
		"bundle": "gregorian",
	...
	"dateTime@localeAlias470": {
		"bundle": "islamic",
		"target": "dateTime"
	},
	"dateTime@localeAlias471": {
		"bundle": "generic",
		"target": "dateTime"
	},
	...
	"days-standAlone-abbr@localeAlias446": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"field-zone": "Zone",
	"days-standAlone-abbr@localeAlias447": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"dateFormatItem-MMMEd": "MMM d, E",
	"dateFormatItem-EHms": "E HH:mm:ss",
	"days-standAlone-wide@localeAlias451": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"field-day-relative+-1": "yesterday",
	"quarters-format-narrow@localeAlias455": {
		"bundle": "gregorian",
		"target": "quarters-standAlone-narrow"
	},
	"quarters@localeAlias452": {
		"bundle": "islamic",
		"target": "quarters"
	},
	"days-format-abbr": [
