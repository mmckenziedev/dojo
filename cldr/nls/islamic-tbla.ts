...
//begin v1.x content
{
	...
	"quarters-standAlone-abbr@localeAlias420": {
		"bundle": "gregorian",
		"target": "quarters-format-abbr"
	},
	"field-minute": "Minute",
	"quarters-standAlone-abbr@localeAlias421": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"quarters-format-abbr@localeAlias418": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	...
	"months-standAlone-wide@localeAlias403": {
		"bundle": "islamic",
		"target": "months-format-wide"
	},
	"days-standAlone-short@localeAlias412": {
		"bundle": "gregorian",
		"target": "days-format-short"
	},
	"days-format-short@localeAlias408": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-standAlone-short@localeAlias413": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"dateFormatItem-MMMd": "MMM d",
	"days-format-short@localeAlias409": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"days-standAlone-short@localeAlias414": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"dayPeriods-format-abbr@localeAlias425": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-wide"
	},
	"dayPeriods-format-abbr@localeAlias426": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-wide"
	},
	...
	"months-standAlone-abbr@localeAlias402": {
		"bundle": "islamic",
	...
	"timeFormat@localeAlias432": {
		"bundle": "islamic",
		"target": "timeFormat"
	},
	"timeFormat@localeAlias433": {
		"bundle": "gregorian",
		"target": "timeFormat"
	},
	...
	"dayPeriods@localeAlias423": {
		"bundle": "islamic",
		"target": "dayPeriods"
	},
	"dayPeriods@localeAlias424": {
		"bundle": "gregorian",
		"target": "dayPeriods"
	},
	"eraAbbr": [
	...
	"days-format-narrow@localeAlias407": {
		"bundle": "gregorian",
	...
	"dateTime@localeAlias434": {
		"bundle": "islamic",
		"target": "dateTime"
	},
	"dateTime@localeAlias435": {
		"bundle": "generic",
		"target": "dateTime"
	},
	...
	"days-standAlone-wide@localeAlias415": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"dateFormatItem-hm": "h:mm a",
	"quarters-format-narrow@localeAlias419": {
		"bundle": "gregorian",
		"target": "quarters-standAlone-narrow"
	},
	"quarters@localeAlias416": {
		"bundle": "islamic",
		"target": "quarters"
	},
	"quarters@localeAlias417": {
		"bundle": "gregorian",
		"target": "quarters"
	},
	"days-standAlone-abbr@localeAlias410": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-standAlone-abbr@localeAlias411": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"dateFormatItem-d": "d",
	...
	"days-format-abbr@localeAlias406": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"months-format-narrow@localeAlias401": {
		"bundle": "islamic",
	...
	"dateFormat@localeAlias430": {
		"bundle": "islamic",
		"target": "dateFormat"
	},
	"dateFormat@localeAlias431": {
		"bundle": "generic",
		"target": "dateFormat"
	},
	"field-zone": "Zone",
	"quarters-standAlone-wide@localeAlias422": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
