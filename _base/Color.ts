...
import ArrayUtil = require("./array");
import config = require("./config");

const Color = dojo.Color = function( /*Array|String|Object*/ color) {
    // summary:
...
lang.extend(Color, {
    ...
    toHex() {
        ...
        //	|	});
        const arr = ArrayUtil.map(["r", "g", "b"], function(x) {
            const s = this[x].toString(16);
