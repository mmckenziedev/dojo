...
import arrayUtil from "../_base/array";
import jsonUtil from "../_base/json";
import kernel from "../_base/kernel";
import ItemFileReadStore from "./ItemFileReadStore";
import dateStamp from "../date/stamp";

// module:
//		dojo/data/ItemFileWriteStore

export default declare("dojo.data.ItemFileWriteStore", ItemFileReadStore, {
    // summary:
    //		TODOC
