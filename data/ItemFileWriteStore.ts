...
import arrayUtil = require("../_base/array");
import jsonUtil = require("../_base/json");
import kernel = require("../_base/kernel");
import ItemFileReadStore = require("./ItemFileReadStore");
import dateStamp = require("../date/stamp");

// module:
//		dojo/data/ItemFileWriteStore

export = dojoDeclare("dojo.data.ItemFileWriteStore", ItemFileReadStore, {
    // summary:
    //		TODOC
    ...
    constructor: function( /* object */ keywordParameters) {
        ...
        if (!this._datatypeMap['Date'].serialize) {
            this._datatypeMap['Date'].serialize = function(obj) {
                return dateStamp.toISOString(obj, {
                    zulu: true
                });
            };
        }
    ...
    _flatten: function( /* anything */ value) {
        if (this.isItem(value)) {
            ...
            //	  {_reference:2}
            return {
                _reference: this.getIdentity(value)
            };
        } else {
