import on from '../on';
import has from '../has';
import baseWin from '../_base/window';
import domConstruct from 'dojo/has!host-browser?../dom-construct';
import 'dojo/has!host-browser?../domReady!';
// summary:
...
var testNode,
    ...
    requiresClone = false;
if (domConstruct) {
    testNode = domConstruct.create('input', {
            type: 'button'
        }, baseWin.body()),
