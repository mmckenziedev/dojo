...
import kernel from '../_base/kernel';
import array from '../_base/array';
import lang from '../_base/lang';
import on from '../on';
import dom from '../dom';
import domConstruct from '../dom-construct';
import has from '../has';
import win from '../_base/window';
...
script.__BaseOptions = dojoDeclare(request.__BaseOptions, {
	// jsonp: String?
...
script.__MethodOptions = dojoDeclare(null, {
	// method: String?
	//		This option is ignored. All requests using this transport are
	//		GET requests.
});
script.__Options = dojoDeclare([script.__BaseOptions, script.__MethodOptions]);
