...
node.__BaseOptions = dojoDeclare(request.__BaseOptions, {
...
node.__MethodOptions = dojoDeclare(null, {
	// method: String?
	//		The HTTP method to use to make the request. Must be
	//		uppercase. Default is `"GET"`.
});
node.__Options = dojoDeclare([node.__BaseOptions, node.__MethodOptions]);
