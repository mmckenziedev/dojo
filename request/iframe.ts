...
iframe.__BaseOptions = dojoDeclare(request.__BaseOptions, {
	// form: DOMNode?
...
iframe.__MethodOptions = dojoDeclare(null, {
	// method: String?
	//		The HTTP method to use to make the request. Must be
	//		uppercase. Only `"GET"` and `"POST"` are accepted.
	//		Default is `"POST"`.
});
iframe.__Options = dojoDeclare([iframe.__BaseOptions, iframe.__MethodOptions]);
